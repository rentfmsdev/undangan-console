...
export function EditableField({
  ...
  const inputClass = `mt-1.5 w-full rounded-xl border bg-white px-3 py-2 text-xs font-semibold text-slate-800 outline-none transition placeholder:text-slate-400 disabled:bg-slate-100 disabled:text-slate-500 disabled:cursor-not-allowed ${
    isCollaborating
      ? ""
  ...
  return (
    ...
    >
      ...
      <label className="block">
        ...
        {field.control === "select" ? (
          ...
          <button
            ...
            className={`mt-2 flex w-full items-center justify-between rounded-xl border px-3 py-2.5 text-xs font-bold transition disabled:opacity-60 disabled:cursor-not-allowed ${Boolean(value) ? "border-emerald-300 bg-emerald-50 text-emerald-800" : "border-slate-200 bg-slate-50 text-slate-500"}`}
          >
          ...
          <div className="mt-2 flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5">
            <input
              ...
              className="h-1.5 min-w-0 flex-1 accent-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed"
            />
      ...
      {supportsTypography && !primitiveControl && !disabled && (
        <div className="mt-3 border-t border-slate-100 pt-2">
          <button
            ...
            className="flex w-full items-center justify-between rounded-lg px-1 py-1.5 text-left text-[11px] font-semibold text-slate-500 transition hover:bg-slate-50 hover:text-emerald-700 disabled:opacity-40 disabled:cursor-not-allowed"
          >
