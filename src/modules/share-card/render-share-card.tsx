...
function resolveDisplayFont(font: string | undefined): string {
  if (font === "Great Vibes") return "Great Vibes";
  if (font === "Dancing Script") return "Dancing Script";
  if (font === "Manrope") return "Manrope";
...
export function renderShareCard(data: InvitationShareData) {
  ...
  return (
    ...
    >
      {cardStyle.backgroundMode === "photo" && cardStyle.imageUrl ? (
        <img
      ...
      >
        ...
        <div
          style={{
            ...
            fontSize: data.subject.length > 34 ? 48 : 60,
            fontWeight: 400,
            lineHeight: 1.08,
            color: textColor,
            textAlign: cardStyle.textAlign,
          ...
          >
            ...
            <div
              style={{
                ...
                maxWidth: 900,
                fontFamily: "Manrope, sans-serif",
                fontSize: data.guestName.length > 34 ? 43 : 52,
                fontWeight: 700,
                color: textColor,
                marginBottom: 24,
                textAlign: cardStyle.textAlign,
